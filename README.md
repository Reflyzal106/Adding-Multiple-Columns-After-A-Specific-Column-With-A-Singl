# [SOLVED] Adding-Multiple-Columns-After-A-Specific-Column-With-A-Singl
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/adding-multiple-columns-after-a-specific-column-with-a-singl)
>
...
Use the following syntax: ALTER TABLE `users` ADD COLUMN `count` smallint(6) NOT NULL, `log` varchar(12) NOT NULL, `status` int(10) unsigned NOT NULL AFTER `lastname`;
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/adding-multiple-columns-after-a-specific-column-with-a-singl)**
